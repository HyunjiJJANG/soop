...
public class MemberController {
	...
	public String passwordChange(@ModelAttribute MemberDTO memberDto, @RequestParam("password") String password, RedirectAttributes redirectAttributes) {
		 ...
		 MimeMessage message = javaMailSender.createMimeMessage();
	       ...
	       // helper.setTo(email); // 스크립트에서 보낸 메일을 받을 사용자 이메일 주소
	        ...
	        String content = "<div style=\"border: 2px solid #7EAA92; border-radius: 10px; background-color: #ffffff;\">\n" +
	                ...
	                "                  안녕하세요. SOOP입니다.<br>\n" +
	                "                  이메일 계정을 인증받으시려면 인증 번호를 확인해주세요. <br/><strong style=\"color: #00A558;\">인증번호 : " +  key + "</strong><br>\n" +
