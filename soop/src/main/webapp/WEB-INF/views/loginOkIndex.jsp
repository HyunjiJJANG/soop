...
<body>
	...
	<h1>
		<a	href="/contact?member_no=${memberDto.member_no }&email=${memberDto.email}&project_no=1">/주소록</a>
	</h1>
	<h1>
		<a	href="/historyList?member_no=${memberDto.member_no }&email=${memberDto.email}">히스토리</a>
	</h1>
	...
	<h1>
		<a href="/contact?member_no=${memberDto.member_no }&email=${memberDto.email}">/주소록</a>
	</h1>
	<h1>
	...
	<h1>
		<a href="/contact?member_no=${memberOauth2Dto.member_no }&email=${memberOauth2Dto.email}">/주소록</a>
	</h1>
		<h1>
